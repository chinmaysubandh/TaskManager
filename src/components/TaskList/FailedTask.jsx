...
const FailedTask = ({data}) => {
  return (
      <div className='h-full w-[300px] bg-red-950 rounded-xl shrink-0 '>
          ...
          <div className='flex justify-center mt-2'>
              <button className='bg-red-800 ring-1 hover:bg-red-500 mx-3 my-2 px-4 py-2 rounded-4xl text-sm font-bold'>Failed</button>
          </div>
      </div>
  )
}
