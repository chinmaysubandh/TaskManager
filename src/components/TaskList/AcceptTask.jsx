    ...
    return (
        <div className='h-full w-[300px] bg-yellow-800 rounded-xl shrink-0 '>
            ...
            <div className='flex justify-between mt-2'>
                <button onClick={onComplete} className='bg-green-900 ring-1 hover:bg-green-800 mx-3 my-1 px-2 rounded-4xl text-sm font-bold'>Mark as Completed</button>
                <button onClick={onFail} className='bg-red-900 ring-1 hover:bg-red-800 mx-3 my-1 px-2  rounded-full text-sm font-bold'>Mark as Failed</button>
            </div>
        </div>
    )
}
